<template>
  <v-container fluid>
    ...
    <v-row>
      ...
      <v-col xs10>
        <v-text-field v-on:keyup.enter.native="submit" v-model="searchBar" label="Ethereum Network" hint="search for project tags, adresses, transactions, ..." autofocus></v-text-field>
      </v-col>
    </v-row>
  </v-container>
</template>
